...
class Hotel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: isHotelView == null
          ? EdgeInsets.symmetric(horizontal: 15, vertical: 17)
          : EdgeInsets.symmetric(horizontal: 10, vertical: 9),
      margin: isHotelView == null
          ? EdgeInsets.only(top: 5, right: 17)
      ...
      child: Column(
        ...
        children: [
          Container(
            height: isHotelView == null
                ? AppLayout.getHeight(180)
                : AppLayout.getHeight(86),
            decoration: BoxDecoration(
